...
namespace Manicomio.ActionableObjects {
    public abstract class ActionableObject : MonoBehaviour, IActionableObject {
        ...
        public string GetInteractionTextReverse() {
            return interactionTextReverse;
        }

        public void Interact(GameObject interactor = null) {
            InnerInteract(interactor);
            m_interacted = !m_interacted;
        }

        protected virtual void InnerInteract(GameObject interactor = null) { }
